export default function ContactPage() {
  return (
    <div className="container mx-auto px-4 py-12 min-h-[calc(100vh-128px)] max-w-3xl">
      <h1 className="text-5xl font-bold text-center text-[#fcfcfc] mb-8">Fale Conosco</h1>
      <p className="text-lg text-center text-[#fcfcfc] mb-10">
      ...
      <div className="bg-white p-5 rounded-xl shadow-lg border border-gray-200">
        <form>
          <div className="mb-4">
            ...
            <input type="text" id="firstName" className="w-full p-3 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#483078]" />
          </div>
          <div className="mb-6">
            <label htmlFor="lastName" className="block text-sm font-bold text-gray-700 mb-2">Sobrenome</label>
            <input type="text" id="lastName" className="w-full p-3 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#483078]" />
          </div>
          <div className="mb-6">
            <label htmlFor="contactEmail" className="block text-sm font-bold text-gray-700 mb-2">E-mail</label>
            <input type="email" id="contactEmail" className="w-full p-3 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#483078]" />
          </div>
          <div className="mb-6">
            <label htmlFor="message" className="block text-sm font-bold text-gray-700 mb-2">Sua Mensagem</label>
            <textarea id="message" rows={5} className="w-full p-3 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#483078]"></textarea>
          </div>
          <button
            type="submit"
