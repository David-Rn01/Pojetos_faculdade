  ...
  return (
    <>
      ...
      <div className="w-full space-y-16">
        ...
        {/* --- 2. Substituímos a Seção Hero antiga pelo Carrossel --- */}
...
const CategoryLink = ({ icon, name }: { icon: React.ReactNode, name: string }) => (
  <Link
    href="#"
    className="flex flex-col items-center justify-center p-6 bg-gray-800 rounded-xl shadow-md
               text-gray-400 hover:text-white border border-gray-700 hover:border-blue-500 
               transition-all duration-300 group hover:-translate-y-1"
  >
    <div className="text-gray-500 group-hover:text-blue-400 transition-colors mb-3">
      {icon}
    </div>
